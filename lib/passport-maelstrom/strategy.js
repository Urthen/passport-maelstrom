...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://prototype.projectmaelstrom.com/module/login';
  options.tokenURL = options.tokenURL || 'http://prototype.projectmaelstrom.com/module/token/exchange';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('http://prototype.projectmaelstrom.com/module/token/info', accessToken, function (err, body, res) {
